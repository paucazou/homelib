...
class NewBookWindow(Dialog):
    ...
    def retranslateUI(self):
        ...
        self.new_author_button.setText(_("NewBookWindow","New author (Ctrl+R)"))
        self.new_publisher_button.setText(_("NewBookWindow","New publisher (Ctrl+S)"))
        self.new_box_button.setText(_("NewBookWindow","New box (Ctrl+B)"))
        self.preview_box_button.setText(_("NewBookWindow","Preview box (Alt+W)"))
